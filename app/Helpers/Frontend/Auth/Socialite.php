...
class Socialite
{
    ...
    public function getSocialLinks()
    {
        ...
        if (config('services.facebook.active')) {
            $socialite_enable[] = "<a href='".route('frontend.auth.social.login', 'facebook')."' class='btn btn-outline-info m-1'><i class='fab fa-facebook'></i>  ".__('labels.frontend.auth.login_with', ['social_media' => 'Facebook']).'</a>'; // btn-sm
        }
