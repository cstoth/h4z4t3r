 ...
 * Class SendAdvertise.
 */
class SendAdvertise extends Mailable
{
    ...
    public function build()
    {
        return $this->to($this->user->email, $this->user->full_name)
            ->view('frontend.mail.advertise')
            ->text('frontend.mail.advertise-text')
            ->subject(__('strings.emails.advertise.subject', ['app_name' => app_name(), 'route_label' => Hazater::routeLabel($this->advertise->id)]))
