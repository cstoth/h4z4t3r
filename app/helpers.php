...
if (! function_exists('form_submit')) {
     ...
     * @return mixed
     */
    function form_submit($title, $classes = 'btn btn-success pull-right') // btn-sm
    {
...
if (! function_exists('button_ok')) {
     ...
     * @return mixed
     */
    function button_ok($title, $target, $classes = 'btn btn-success pull-right') // btn-sm
    {
        return resolve(HtmlHelper::class)->buttonOk($title, $target, $classes);
    }
}
