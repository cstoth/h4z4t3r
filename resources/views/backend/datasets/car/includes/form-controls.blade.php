...
<div class="form-group row">
    ...
    <div class="col-md-10">
        {{ html()->text('image2')
            ->class('form-control')
            ->placeholder(__('validation.attributes.backend.datasets.car.image2'))
            ->attribute('maxlength', 191) }}
    </div><!--col-->
</div><!--form-group-->
...
<div class="form-group row">
    ...
    <div class="col-md-10">
        <label class="switch switch-label switch-pill switch-primary">
            ...
            {{ html()->checkbox('smoke', isset($car) ? $car->smoke : false, '1')->class('switch-input') }}
...
<div class="form-group row">
    ...
    <div class="col-md-10">
        <label class="switch switch-label switch-pill switch-primary">
            ...
            {{ html()->checkbox('cooler', isset($car) ? $car->cooler : false, '1')->class('switch-input') }}
            <span class="switch-slider" data-checked="igen" data-unchecked="nem"></span>
        </label>
    </div><!--col-->
</div><!--form-group-->
...
<div class="form-group row">
    ...
    <div class="col-md-10">
        <label class="switch switch-label switch-pill switch-primary">
            ...
            {{ html()->checkbox('pet', isset($car) ? $car->pet : false, '1')->class('switch-input') }}
            <span class="switch-slider" data-checked="igen" data-unchecked="nem"></span>
        </label>
    </div><!--col-->
</div><!--form-group-->
...
<div class="form-group row">
    ...
    <div class="col-md-10">
        <label class="switch switch-label switch-pill switch-primary">
            ...
            {{ html()->checkbox('bag', isset($car) ? $car->bag : false, '1')->class('switch-input') }}
            <span class="switch-slider" data-checked="igen" data-unchecked="nem"></span>
        </label>
    </div><!--col-->
</div><!--form-group-->
