    ...
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            @if ($logged_in_user->isAdmin())
                ...
                <li class="nav-item nav-dropdown {{ active_class(Active::checkUriPattern('admin/datasets*'), 'open') }}">
                    <a class="nav-link nav-dropdown-toggle {{ active_class(Active::checkUriPattern('admin/datasets*')) }}" href="#">
                        <i class="nav-icon icon-home"></i> @lang('menus.backend.datasets.title')
                    ...
                    <ul class="nav-dropdown-items">
                        <li class="nav-item">
                            <a class="nav-link {{ active_class(Active::checkUriPattern('admin/datasets/city*')) }}" href="{{ route('admin.datasets.city.index') }}">
                    ...
                    <ul class="nav-dropdown-items">
                        <li class="nav-item">
                            <a class="nav-link {{ active_class(Active::checkUriPattern('admin/datasets/car*')) }}" href="{{ route('admin.datasets.car.index') }}">
