...
<a href="{{ route('frontend.advertise.reserve', $advertise->id) }}"><img src="{{ $message->embed(asset('img/frontend/email/' . __('mails.delete.image'))) }}" alt="@lang('mails.delete.button')"></a><br>
