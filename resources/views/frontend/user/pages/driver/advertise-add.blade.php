<form method="POST" action="{{route('frontend.user.advertise.store')}}" class="form-horizontal" autocomplete="off">
    {{ csrf_field() }}
    ...
    <div class="form-row">
        <div class="col">
            ...
            <input class="form-control typeahead typeahead-start-city" id="start_city" name="start_city" placeholder="{{ __('dashboard.driver.submit-ad.Start Place') }}" type="text" autocomplete="anyrandomstring">
        </div>

        <div class="col">
            <label for="start_date">{{ __('dashboard.driver.submit-ad.Start Date') }}</label>
            <div class='input-group'>
                <input type='text' id="start_date" name="start_date" class="form-control date" autocomplete="off"/>
    ...
    <div class="form-row">
        <div class="col">
            ...
            <input class="form-control typeahead typeahead-end-city" id="end_city" name="end_city" placeholder="{{ __('dashboard.driver.submit-ad.Target Place') }}" type="text" autocomplete="off">
        </div>

        <div class="col">
            <label for="end_date">{{ __('dashboard.driver.submit-ad.Target Date') }}</label>
            <div class='input-group'>
                <input type='text' id="end_date" name="end_date" class="form-control date" autocomplete="off"/>
                <span class="input-group-addon">
                    <span class="glyphicon glyphicon-calendar"></span>
                </span>
            </div>
    ...
    <div class="col">
        <div class="panel panel-default map-panel">
            <div style="width: 100%; height: 314px" id="mapContainerAdvertise"></div>
        </div>
    </div>
...
var mapAdvertise = makeMap('mapContainerAdvertise', mapInitCenter);
...
function getSeatsFromcar(car_id) {
...
$('#car_id').on('change', function() {
    var seats = getSeatsFromcar($('#car_id').val());
    $("#ules").empty().append(makeNumList(seats));
});
