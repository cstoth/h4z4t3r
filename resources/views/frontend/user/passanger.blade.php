        ...
        <div class="col col-12 align-self-center">
            ...
            <div role="passangertabpanel mt-2">
                ...
                <div class="tab-content">
                    <div role="passangertabpanel" class="driver-menu tab-pane fade show {{$tab==1?'active':''}} pt-3" id="reserves" aria-labelledby="reserves-tab">
                        @include('frontend.user.pages.passanger.reserves')
                    </div>

                    <div role="passangertabpanel" class="driver-menu tab-pane fade show {{$tab==2?'active':''}} pt-3" id="adhunter" aria-labelledby="adhunter-tab">
...
@push('after-scripts')
    <script>
        ...
        @if (isset($_SESSION['PASSANGER_TAB']))
            console.log("PASSANGER_TAB: {{$_SESSION['PASSANGER_TAB']}}");
