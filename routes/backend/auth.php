...
Route::group([
    ...
    //     Route::get('city/create', [RoleController::class, 'create'])->name('city.create');
    //     Route::post('city', [RoleController::class, 'store'])->name('city.store');

    //     Route::group(['prefix' => 'city/{city}'], function () {
    //         Route::get('edit', [RoleController::class, 'edit'])->name('city.edit');
    //         Route::patch('/', [RoleController::class, 'update'])->name('city.update');
    //         Route::delete('/', [RoleController::class, 'destroy'])->name('city.destroy');
    //     });
    // });
});
