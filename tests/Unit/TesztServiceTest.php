...
class TesztServiceTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(TesztService::class);
        $this->originalArray = [
            // Teszt table data
        ];
        $this->editedArray = [
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Models\Teszt');
    ...
    public function testUpdate()
    {
        ...
        $this->assertDatabaseHas('teszts', $this->editedArray);
    }
